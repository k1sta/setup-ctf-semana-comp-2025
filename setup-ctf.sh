...
wget "https://github.com/pwndbg/pwndbg/releases/download/2025.02.19/pwndbg-lldb_2025.02.19_x86_64-portable.tar.xz" -O pwndbg.tar.xz
...
export PATH="$PATH:$(pwd ./ghidra_11.3.1_PUBLIC/ghidraRun):$(pwd ./pwndbg/bin)"
