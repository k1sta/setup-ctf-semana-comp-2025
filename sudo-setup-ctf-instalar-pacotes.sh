...
echo "Placing it on home"
cd /home/convidado

echo "Changing user"
echo <senha-wks> | sudo su convidado
...
echo "Downloads"
python3 -m pip install pycryptodome pwn Pillow
...
echo "Exiting temporary user"
exit

echo "Installing programs with apt"
echo <senha-wks> | sudo apt install hexedit nmap wireshark sleuthkit autopsy -y
